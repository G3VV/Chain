...
client.on("ready", () => {
  ...
  client.other = client.colors.client.otherplus;
...
client.on("guildCreate", guild => {
  const embed = new Discord.RichEmbed()
    .setColor(client.other)
    .setTitle("New Guild")
    .setDescription("Chain Plus has been added to `" + guild.name + "`")
  ...
  const embed2 = new Discord.RichEmbed()
    ...
    .setTitle("Chain Plus")
    .setDescription(
      "Thank you for choosing **Chain Plus**! The bot is ready to use from invite, so to get commands do `%help`!\n\n__**Support Server:**__ https://discord.gg/ft3vEZU\n\n- Chain Bot Developers <:kappa:665407289062326293>"
    )
    .setTimestamp(Date.now());
